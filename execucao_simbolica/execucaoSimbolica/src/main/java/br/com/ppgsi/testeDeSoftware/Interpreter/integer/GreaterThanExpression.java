 ...
 * @author orlando
 */
public class GreaterThanExpression extends OperatorExpression<Constraint>{

    public GreaterThanExpression(Context context, IExpression firstExpression, IExpression secondExpression) {
        super(context, firstExpression, secondExpression);
    }
    
    @Override
    public String toString(){
        return LexerAnalyserImpl.GREATER;
    }
    ...
    public Constraint interpret() {
        ...
        if( stateRight instanceof IntegerExpressionVariable )
            this.setState(Choco.gt((IntegerExpressionVariable)stateLeft, (IntegerExpressionVariable)stateRight));
        else if( stateRight instanceof Integer )
            this.setState(Choco.gt((IntegerExpressionVariable)stateLeft, (Integer)stateRight));
